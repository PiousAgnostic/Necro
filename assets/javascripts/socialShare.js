    ...
    socialShare: function(options) {
      ...
      function createContainer(){
        ...
        for (var i = 0; i <= sites.length-1; i++) {
          ...
          listItem += '<li><a href="../../../necro/assets/javascripts/'+siteSettings[ sites[i] ]['url'] +'" target="_blank" rel="nofollow" class="'+siteSettings[ sites[i] ]['className'] +'"><span></span></a><span>'+siteSettings[ sites[i] ]['text'] +'</span></li>';
        };
