...
SELECT TOP 1 CONVENTIONDATE, DropDeadDate, ConventionName, ConventionEnds, Announcement, ParticipationText, LarpText, HOURSFORFREE, lastgametime, GMGuidelines
	FROM ADMIN
</CFQUERY>
...
<tr>
 ...
 <tr>
	...
	<td align="center">
<cfif Not IsDefined("Review")>
		<form action="gmFirstTime.cfm" method="post">
		<input type="submit" name="fromIndex" value="Agree">&nbsp;&nbsp;&nbsp;
		<input type="button" value="Disagree" onClick="self.location.href='index.cfm'; return false">
		</form>
<cfelse>
